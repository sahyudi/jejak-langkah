...
<head>
  ...
  <title>About Us 2 | Material</title>
    ...
    <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar nav-bg">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?= base_url() ?>index.html"><img src="<?= base_url() ?>assets/images/logo.png" alt=""></a>
        </div>
          ...
          <ul class="navbar-nav mr-auto w-100 justify-content-end">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="<?= base_url() ?>about-us.html">About Us 1</a>
                <a class="dropdown-item active" href="<?= base_url() ?>about-us2.html">About Us 2</a>
                <a class="dropdown-item" href="<?= base_url() ?>team.html">Team Members</a>
                <a class="dropdown-item" href="<?= base_url() ?>services.html">Services</a>
                <a class="dropdown-item" href="<?= base_url() ?>contact-us.html">Contact Us 1</a>
                <a class="dropdown-item" href="<?= base_url() ?>contact-us2.html">Contact Us 2</a>
                <a class="dropdown-item" href="<?= base_url() ?>404.html">404</a>
              </div>
            </li>
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="<?= base_url() ?>tab.html">Tabs</a>
                <a class="dropdown-item" href="<?= base_url() ?>alert.html">Alert</a>
                <a class="dropdown-item" href="<?= base_url() ?>accordion.html">Accordions</a>
                <a class="dropdown-item" href="<?= base_url() ?>pricing.html">Pricing Tables</a>
                <a class="dropdown-item" href="<?= base_url() ?>buttons.html">Buttons</a>
                <a class="dropdown-item" href="<?= base_url() ?>icons.html">Icons</a>
                <a class="dropdown-item" href="<?= base_url() ?>carousel.html">Carousel</a>
                <a class="dropdown-item" href="<?= base_url() ?>counter.html">Counter</a>
                <a class="dropdown-item" href="<?= base_url() ?>map.html">Google Map</a>
              </div>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="<?= base_url() ?>portfolio-2.html">Portfolio 2 columns</a>
                <a class="dropdown-item" href="<?= base_url() ?>portfolio.html">Portfolio 3 columns</a>
                <a class="dropdown-item" href="<?= base_url() ?>portfolio-single.html">Portfolio Single</a>
              </div>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="<?= base_url() ?>blog.html">Blog Page</a>
                <a class="dropdown-item" href="<?= base_url() ?>blog-single.html">Blog Single Page</a>
              </div>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <ul class="wpb-mobile-menu">
        ...
        <li>
          ...
          <ul class="dropdown">
            <li>
              <a href="<?= base_url() ?>about-us.html">About Us 1</a>
            </li>
            <li>
              <a class="active" href="<?= base_url() ?>about-us2.html">About Us 2</a>
            </li>
            <li>
              <a href="<?= base_url() ?>team.html">Team Members</a>
            </li>
            <li>
              <a href="<?= base_url() ?>services.html">Services</a>
            </li>
            <li>
              <a href="<?= base_url() ?>contact-us.html">Contact Us 1</a>
            </li>
            <li>
              <a href="<?= base_url() ?>contact-us2.html">Contact Us 2</a>
            </li>
            <li>
              <a href="<?= base_url() ?>404.html">404</a>
            </li>
          </ul>
        </li>
        <li>
          ...
          <ul class="dropdown">
            <li>
              <a href="<?= base_url() ?>tab.html">Tabs</a>
            </li>
            <li>
              <a href="<?= base_url() ?>alert.html">Alert</a>
            </li>
            <li>
              <a href="<?= base_url() ?>accordion.html">Accordions</a>
            </li>
            <li>
              <a href="<?= base_url() ?>pricing.html">Pricing Tables</a>
            </li>
            <li>
              <a href="<?= base_url() ?>buttons.html">Buttons</a>
            </li>
            <li>
              <a href="<?= base_url() ?>icons.html">Icons</a>
            </li>
            <li>
              <a href="<?= base_url() ?>carousel.html">Carousel</a>
            </li>
            <li>
              <a href="<?= base_url() ?>counter.html">Counter</a>
            </li>
            <li>
              <a href="<?= base_url() ?>map.html">Google Map</a>
            </li>
          </ul>
        </li>
        <li>
          ...
          <ul class="dropdown">
            <li>
              <a href="<?= base_url() ?>portfolio-2.html">Portfolio 2 columns</a>
            </li>
            <li>
              <a href="<?= base_url() ?>portfolio.html">Portfolio 3 columns</a>
            </li>
            <li>
              <a href="<?= base_url() ?>portfolio-single.html">Portfolio Single</a>
            </li>
          </ul>
        </li>
        <li>
          ...
          <ul class="dropdown">
            <li>
              <a href="<?= base_url() ?>blog.html">Blog Page</a>
            </li>
            <li>
              <a href="<?= base_url() ?>blog-single.html">Blog Single Page</a>
            </li>
          </ul>
        </li>
        <li>
          ...
          <div class="video-gallery">
            ...
            <div class="overlay-gallery">
              <div class="icon-holder">
                <div class="icon">
                  <a href="<?= base_url() ?>https://www.youtube.com/watch?v=r44RKWyfcFw" class="video-popup wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="0.3s"><i class="mdi mdi-play-circle-outline"></i></a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row justify-content-between">
        ...
        <div class="col-md-4 col-lg-4 col-xs-12 mt-4 text-right wow animated fadeInRight" data-wow-delay=".3s"><br>
          <a href="<?= base_url() ?>https://rebrand.ly/material-bs4-purchase-ud" rel="nofollow" target="_blank" class="animated4 btn btn-common"><i class="material-icons mdi mdi-cart"></i> Purchase Now</a>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3 col-xl-3 link-widget">
          ...
          <ul>
            ...
            <li><a href="<?= base_url() ?>portfolio-index.html">Portfolio</a></li>
        ...
        <div class="col-md-6 col-lg-3 col-xl-3 footer-contact">
          ...
          <div class="widget widget-gallery">
            <ul class="magnific-gallery">
              <li><a href="#"><img src="<?= base_url() ?>assets/images/gallery/thum1.jpg" alt="instagram image"></a></li>
              <li><a href="#"><img src="<?= base_url() ?>assets/images/gallery/thum2.jpg" alt="instagram image"></a></li>
              <li><a href="#"><img src="<?= base_url() ?>assets/images/gallery/thum3.jpg" alt="instagram image"></a></li>
              <li><a href="#"><img src="<?= base_url() ?>assets/images/gallery/thum4.jpg" alt="instagram image"></a></li>
              <li><a href="#"><img src="<?= base_url() ?>assets/images/gallery/thum5.jpg" alt="instagram image"></a></li>
              <li><a href="#"><img src="<?= base_url() ?>assets/images/gallery/thum6.jpg" alt="instagram image"></a></li>
            </ul>
          </div>
        </div>
        <!--/.Fourth column-->
